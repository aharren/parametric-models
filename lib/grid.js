...
const measureAggregateDimensions = (object) => {
  const boundingBox = measurements.measureAggregateBoundingBox(object);
  return [
...
const distribute = (distances, ...objects) => {
  ...
  objects.forEach(object => {
    ...
    const dimensions = measureAggregateDimensions(object);
