  ...
  const fn = (params) => {
    ...
    if (settings.xRay ?? true) {
      objects = (() => {
        ...
        objects.forEach(object => {
          ...
          if (visuals.isVisual(object)) {
            objectsWithXRay.push(object);
            return;
          }
          objectsWithXRay.push(...visuals.xRay({}, object));
        });
    ...
    if (settings.dimensions ?? true) {
      originalObjects.forEach(object => {
        ...
        if (visuals.isVisual(object) && visuals.visualType(object) !== visuals.TYPE_DEFAULT) {
          return;
        }
        objects.push(visuals.dimensions({}, object));
      });
    }
