...
const detachVisuals = (...objects) => {
  return arrays.filterDeep(objects, (object) => { return !isVisual(object) });
}
...
const main = (params) => {
  ...
  objects[numObjects + 1].color = isVisual(objects[numObjects + 1]) ? [0, 0.75, 0, visualColorAlphaMarker] : [0.75, 0, 0, visualColorAlphaMarker];
